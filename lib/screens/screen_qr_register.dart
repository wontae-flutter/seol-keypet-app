...
import '../common/QRScannerOverlay.dart';
        ...
        child: Column(
          children: [
                ...
                children: [
                  MobileScanner(
                    ...
                    onDetect: (barcode, args) {
                      ...
                      //! 그리고 여기서 다음 페이지로 넘어가야 돼!
                      // Navigator.of(context).pushReplacementNamed("/qr_result",
                      //     arguments: {"barcodeInfo": barcodeInfo});
                      //*
                      // Navigator.pushNamed(
                      //   context,
                      //   '/pet_tabs',
                      //   arguments: {'pid': "CwnCrNuUCD5lvpmmATTF"},
                      // );
                      Navigator.of(context).pop(barcodeInfo);
                    },
                  ),
                  QRScannerOverlay(
            ...
            Container(
              ...
              child: Center(child: Text(barcodeInfo)),
            )
          ],
        ),
      ),
